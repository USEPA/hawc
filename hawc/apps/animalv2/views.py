...
class AnimalGroupViewSet(ExperimentChildViewSet):
    ...
    detail_fragment = "animalv2/fragments/animalgroup_row.html"


class HusbandryViewSet(ExperimentChildViewSet):
    model = models.Husbandry
    form_class = forms.HusbandryForm
    detail_fragment = "animalv2/fragments/husbandry_row.html"
...
class DosePreparationViewSet(ExperimentChildViewSet):
    model = models.DosePreparation
    form_class = forms.DosePreparationForm
    detail_fragment = "animalv2/fragments/dosepreparation_row.html"
