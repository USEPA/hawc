...
urlpatterns = [
    ...
    path(
        "testsubstance/<int:pk>/<slug:action>/",
        views.TestSubstanceViewSet.as_view(),
        name="testsubstance-htmx",
    ),
    path(
        "guideline/<int:pk>/<slug:action>/",
