# Generated by Django 5.2.16 on 2026-07-21 20:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True, help_text="Specify the type of test system", max_length=255
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("POSTPURCHASE", "genetically modified after purchase, prior to use"),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("STERILITY", "sterility (absence of bacteria, fungi, yeast)"),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("INTS", "interference with the test system (e.g. cytotoxicity or pH)"),
                            (
                                "PRIN",
                ...
                (
                    "control_type_other",
                    models.CharField(
                        blank=True, help_text="Enter control type information", max_length=255
                    ),
                ),
                (
                    "control_description",
                ...
                (
                    ...
                    models.CharField(blank=True, verbose_name="Remarks on experimental conditions"),
                ),
                ("created", models.DateTimeField(auto_now_add=True)),
                ("last_updated", models.DateTimeField(auto_now=True)),
                (
                    ...
                    django.contrib.postgres.fields.ArrayField(
                        base_field=models.CharField(
                            choices=[
                                ...
                                ("RLU", "RLU"),
                                ("OD", "OD"),
                                ("CPD", "Detected compound (e.g. metabolite detection with LC-MS)"),
                                ("PKA", "Peak area"),
                                ("PKH", "Peak height"),
                                ("FSC", "Forward Scatter"),
                                ("SSC", "Side Scatter"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            ("SHBP", "steroid hormone biosynthetic process - [GO:0120178]"),
                ...
                (
                    "remarks",
                    models.CharField(blank=True, help_text="Include any remarks as appropriate."),
                ),
                (
                    "effect_subtype_term",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True, max_length=2000, verbose_name="Cytotoxicity assay remarks"
                    ),
                ),
                (
                    "interference_tests",
                ...
                ("interference_tests_remarks", models.CharField(blank=True, max_length=2000)),
                (
                    "detection_range",
                    models.CharField(
                        blank=True,
                ...
                ("detection_range_remarks", models.CharField(blank=True, max_length=2000)),
                (
                    "data_calculation",
                    models.CharField(
                        blank=True,
                ...
                ("data_calculation_remarks", models.CharField(blank=True, max_length=2000)),
                (
                    "evaluation",
                    models.CharField(
                        blank=True,
                ...
                (
                    "general_remarks",
                    models.CharField(
                        blank=True, max_length=32768, verbose_name="Remarks on data analysis"
                    ),
                ),
                ("created", models.DateTimeField(auto_now_add=True)),
                ("last_updated", models.DateTimeField(auto_now=True)),
